...
public class SueDAO {
	...
	// 신고글 내용
	final String SELECTONE_SUE = "SELECT S.SNUM, S.BNUM, B.BTITLE, M.MNAME, B.BCONTENT, SC.SCNAME, B.BWDATE, S.SDATE, S.SRESULT FROM BOARD B, SUE S, SUECATEGORY SC, member M WHERE B.BNUM = S.BNUM AND S.SCNUM = SC.SCNUM AND M.MNUM = B.MNUM AND S.BNUM = ?";
