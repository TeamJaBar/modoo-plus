...
<div class="navbar-bg"></div>
      <nav class="navbar navbar-expand-lg main-navbar">
        <!-- 해더 드롭다운 -->
        <div class="btn-group">
          <button type="button" class="btn btn-header" onclick="location.href='main.html'"><img class="mr-3 rounded"src="../../assets/img/favicon.png">모두의 매칭</button>
           <button type="button" class="btn btn-header dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
             <span class="sr-only">Toggle Dropdown</span>
           </button>
             <div class="dropdown-menu">
              	 <a class="dropdown-item" href="match-insert.jsp">매칭 게시글 작성</a>
